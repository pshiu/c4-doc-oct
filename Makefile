...
quality: ## check coding style with pycodestyle and pylint
	...
	pylint c4_doc_oct tests test_utils *.py
	rm tests/__init__.py
	pycodestyle c4_doc_oct tests  *.py
	pydocstyle c4_doc_oct tests *.py
	isort --check-only --diff tests test_utils c4_doc_oct *.py test_settings.py
