#!/usr/bin/env python
"""
Package metadata for c4_doc_oct.
"""
import os
import re
import sys
...
VERSION = get_version('c4_doc_oct', '__init__.py')
...
setup(
    name='c4-doc-oct',
    version=VERSION,
    description="""A documentation generator for the C4 diagramming model.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='info@edx.org',
    url='https://github.com/edx/c4-doc-oct',
    packages=find_packages(
        include=['c4_doc_oct', 'c4_doc_oct.*'],
        exclude=["*tests"],
    ),
