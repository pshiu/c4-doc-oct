...
"""
c4-doc-oct documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'c4-doc-oct',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edx/c4-doc-oct",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A documentation generator for the C4 diagramming model.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'c4_doc_oct'),
                os.path.join(root_path, 'c4_doc_oct/migrations')])
